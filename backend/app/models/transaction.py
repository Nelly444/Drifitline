...
from sqlalchemy import Boolean, Date, DateTime, Float, ForeignKey, Numeric, func
...
class Transaction(Base):
    ...
    is_drift: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
